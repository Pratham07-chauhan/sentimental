...
with tab1:
    ...
    st.markdown("<div style='color:rgba(255,255,255,0.5);font-size:0.83rem;margin-bottom:0.5rem;'>💡 Tip: Single tweet ya multiple tweets likh sakte ho — <b style='color:#e94560'></b> likho!</div>", unsafe_allow_html=True)
